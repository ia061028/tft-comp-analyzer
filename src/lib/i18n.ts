...
const ja = {
  ...
  noFullUse: '{n}枚すべてを同時に使った構成は、採用数 {x} 以上ではまだ見つかっていません。盤面とその紋章の組み合わせが完全に一致する試合は出現頻度が低く、データが増えると現れます。',
  emblemCatSpatula: 'へら',
  emblemCatPan: 'フライパン',
  emblemCatNone: '合成不可',
...
const en: Record<UIKey, string> = {
  ...
  noFullUse: 'No comp using all {n} at once has reached {x} games yet. An exact board plus that exact emblem combination is rare; they appear as more data comes in.',
