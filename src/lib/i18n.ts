...
const ja = {
  ...
  frequency: '頻度',
  dimLowSample: '少数を薄く',
  dimLowSampleTitle: '採用数が {n} 以下の構成を淡く表示します。一覧からは除外しません。',
  metricRate: '採用',
...
const en: Record<UIKey, string> = {
  ...
  sortAdopt: 'Adoption',
  frequency: 'Frequency',
  dimLowSample: 'Dim low sample',
  dimLowSampleTitle: 'Fades comps with {n} or fewer games. Nothing is removed from the list.',
  metricRate: 'Use',
  ...
  sectionPartialUse: 'Comps using only some',
