...
const ja = {
  ...
  maxPlaceTitle: '平均順位がこの数より悪い（大きい）構成を一覧から外します。空欄なら絞りません。',
  minTop4Title: 'Top4率がこの % に満たない構成を一覧から外します。空欄なら絞りません。',
  minWinTitle: '1位率がこの % に満たない構成を一覧から外します。空欄なら絞りません。',
  metricRate: '採用',
...
const en: Record<UIKey, string> = {
  ...
  maxPlaceTitle: 'Hides comps whose average placement is worse (higher) than this. Blank means no filter.',
  minTop4Title: 'Hides comps with a top-4 rate below this %. Blank means no filter.',
  minWinTitle: 'Hides comps with a win rate below this %. Blank means no filter.',
  metricRate: 'Use',
