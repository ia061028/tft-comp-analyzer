...
const ja = {
  ...
  patch: 'パッチ',
  patchTitle: '集計対象のパッチ。「直近N日」は今のパッチの最新の試合からN日分、「全体」は現セットの全パッチ合算',
  recentDays: '直近{n}日',
...
const en: Record<UIKey, string> = {
  ...
  patch: 'Patch',
  patchTitle: 'Patch to aggregate. "Last N days" covers the N days up to the newest game of the current patch; "All" combines every patch of the current set',
  recentDays: 'Last {n}d',
